...
const Slide:React.FC<propType> = ({img,title,mainTitle,price}) => {
  return (
 ...
 <h3 className='text-[24px] text-gray-500'>
  starting at{" "}
<b className='text-[20px] md:text:[24px] lg:text-[30px]'></b>
 </h3>
...
SHOP NOW
      ...
      <Image
      className='w-[100%] h-[300px] md:h-[600px] rounded-xl object-cover object-right md:object-left-bottom'
      src={img}
      alt='banner'
      width={2000}
      height={2000}
